...
static void run_struct_write_tests (void)
{
    ...
    bytes_written = tlv_write_struct (buffer_small, sizeof(buffer_small), &message, struct_table);
    expect_true ("struct write small buffer fails", bytes_written == 0);

    bytes_written = tlv_write_struct (buffer_large, sizeof(buffer_large), &message, struct_table);
...
static void run_struct_parse_tests (void)
{
    ...
    bytes_parsed = tlv_parse_struct (buffer_bad_crc, sizeof(buffer_bad_crc), &guarded, guarded_table);
    ...
    init_guarded_message (&guarded);
    bytes_parsed = tlv_parse_struct (buffer_bad_truncated, sizeof(buffer_bad_truncated), &guarded, guarded_table);
    ...
    bytes_parsed = tlv_parse_struct (buffer_unknown_types, sizeof(buffer_unknown_types), &message, struct_table);
    ...
    init_guarded_message (&guarded);
    bytes_parsed = tlv_parse_struct (buffer_bad_lengths, sizeof(buffer_bad_lengths), &guarded, guarded_table);
    ...
    init_guarded_message (&guarded);
    bytes_parsed = tlv_parse_struct (buffer_bad_known_length, sizeof(buffer_bad_known_length), &guarded, guarded_table);
    ...
    memset (&message, 0, sizeof(message));
    bytes_parsed = tlv_parse_struct (buffer_duplicate_type, sizeof(buffer_duplicate_type), &message, struct_table);
    ...
    bytes_parsed = tlv_parse_struct (buffer_missing_type, sizeof(buffer_missing_type), &message, struct_table);
    ...
    memset (&message, 0, sizeof(message));
    bytes_parsed = tlv_parse_struct (buffer_reordered_table, sizeof(buffer_reordered_table), &message, struct_table_reordered);
